...
const ThreadRepositoryPostgres = require('./repository/database/postgres/ThreadRepositoryPostgres');
const CommentRepositoryPostgres = require('./repository/database/postgres/CommentRepositoryPostgres');
